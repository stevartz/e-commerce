package com.upsidle.config.jpa;

import com.upsidle.backend.persistent.domain.base.ApplicationAuditorAware;
...
@EnableJpaRepositories(basePackages = "com.upsidle.backend.persistent.repository")
@EntityScan(basePackages = "com.upsidle.backend.persistent.domain")
