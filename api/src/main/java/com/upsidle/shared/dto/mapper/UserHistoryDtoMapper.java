package com.upsidle.shared.dto.mapper;
...
public interface UserHistoryDtoMapper {
  ...
  @Mapping(
      ...
      expression =
          "java(com.upsidle.shared.util.core.DateUtils.getTimeElapsedDescription(userHistory.getCreatedAt()))")
  @Mapping(
      target = "separateDateFormat",
      expression =
          "java(com.upsidle.shared.util.core.DateUtils.getTimeElapsed(userHistory.getCreatedAt()))")
